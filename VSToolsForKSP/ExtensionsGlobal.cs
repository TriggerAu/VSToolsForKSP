//------------------------------------------------------------------------------
// <copyright file="CorePackage.cs" company="TriggerTech">
...
namespace VSToolsForKSP
{
    ...
    [Guid(ExtensionsGlobal.PackageGuidString)]
    ...
    public sealed class ExtensionsGlobal : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "7b99351a-c843-4720-abc8-78c85e1244c0";

        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionsGlobal"/> class.
        /// </summary>
        public ExtensionsGlobal()
        {
        ...
        //internal static void WriteOutputPane(string format,params Object[] args)
        //{
        //    generalPane.OutputString(string.Format(format,args));
